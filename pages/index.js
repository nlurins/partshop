    ...
    <div className="">
      ...
      <main>
        ...
        <div className='w-[100%] h-[100vh] fixed backdrop-filter backdrop-blur'>
          ...
          <div className='flex flex-col max-w-[90%] mx-auto text-white pt-10 md:pt-[10%]'>
            ...
            <Link href="/shop"><button size="large" className='self-center lg:self-start hover:bg-blue-gray-200 transition-transform  hover:scale-110 md:max-w-[400px] min-w-[300px] h-16 lg:mt-24 mt-10 md:mt-32 text-center font-bold text-2xl  bg-white text-black border shadow-inner'>SHOP NOW!</button></Link>
          </div>
        </div>
